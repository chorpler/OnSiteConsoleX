...
// const WHATURL   = WHATWG.URL;
// const windowPlus = require('electron-window-plus');
// Module to control application life.
import { URL as WHATURL, parseURL as whatParseURL} from 'whatwg-url';
...
function createSplashWindow(loadDevTools?:boolean) {
...
async function showDialogPromise(dialogOpts:any):Promise<any> {
  try {
    let opts:any = {};
    let keys:string[] = Object.keys(dialogOpts);
    for(let key of keys) {
