...
function () {
  function PDFSidebar(options, eventBus) {
    ...
    this.isInitialViewSet = false;
    this.sidebarPagesCount = options.sidebarPagesCount;
    this.onToggled = null;
  ...
  _createClass(PDFSidebar, [{
    ...
    value: function setPagesCount(pagesCount) {
      this.sidebarPagesCount.innerText = pagesCount;
    }
  }, {
    key: "_dispatchEvent",
    value: function _dispatchEvent() {
    ...
    value: function _showUINotification(view) {
      ...
      if (!this.isOpen) {} else if (view === this.active) {
        return;
      }
...
var PDFAttachmentViewer = function PDFAttachmentViewer(_ref) {
  var container = _ref.container,
      eventBus = _ref.eventBus,
...
var PDFFindBar = function PDFFindBar(options) {
...
var PDFOutlineViewer = function PDFOutlineViewer(_ref) {
  var container = _ref.container,
