...
@IonicPage({name: 'Flagged Other Reports'})
@Component({
  selector: 'page-flagged-reports-other',
  templateUrl: 'flagged-reports-other.html',
})
export class FlaggedReportsOtherPage implements OnInit,OnDestroy {
  public title         : string    = "Flagged Misc Reports";
  ...
  public get prefs()      : any { return FlaggedReportsOtherPage.PREFS; }               ;
